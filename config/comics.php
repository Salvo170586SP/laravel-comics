...
return [
    [
        ...
        "thumb" => "img/comics/locandina.jpg",
        "price" => "$19.99",
    ...
    [
        ...
        "thumb" => "img/comics/american_vampire.jpg",
        "price" => "$3.99",
    ...
    [
        ...
        "thumb" => "img/comics/Batman_beyond.jpg",
        "price" => "$2.99",
    ...
    [
        ...
        "thumb" => "img/comics/Superman-batman.png",
        "price" => "$3.99",
    ...
    [
        ...
        "thumb" => "img/comics/batman_superman_annual.jpg",
        "price" => "$4.99",
    ...
    [
        ...
        "thumb" => "img/comics/batman_joker.jpg",
        "price" => "$5.99",
    ...
    [
        ...
        "thumb" => "img/comics/Batman_Three_Jokers.jpg",
        "price" => "$6.99",
    ...
    [
        ...
        "thumb" => "img/comics/Batman_Harley.jpg",
        "price" => "$4.99",
